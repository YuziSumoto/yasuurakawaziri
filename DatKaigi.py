...
class DatKaigi(db.Model):
  ...
  Title             = db.StringProperty(multiline=False)      # 表題
  Naiyo             = db.StringProperty(multiline=False)      # 会議内容
  Syusseki          = db.StringProperty(multiline=True)       # 出席者
  Kaisu             = db.IntegerProperty()                    # 回数
